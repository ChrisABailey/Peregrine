...
#include "dtcc/Enumerations/Precision.h"
#include "dtcc/Enumerations/SourceOrTarget.h"
...
namespace MSP
{
   ...
   */
    ...
    /* Symbolic constants */
    const int NUMBER_COORD_SYS = 37;       /* Number of coordinate systems        */
...
//compiler bug on solaris 8. Parameters needs to be public
    ...
    public:
      ...
      struct Coordinate_State_Row
      {
        ...
        CoordinateSystem* coordinateSystem;  /* current coordinate system */
      };
      ...
      void copyParameters( SourceOrTarget::Enum direction, CoordinateType::Enum coordinateType, Parameters parameters );
      ...
      void setCoordinateSystem( const SourceOrTarget::Enum direction, MSP::CCS::CoordinateSystemParameters* parameters );
      ...
      void convert( SourceOrTarget::Enum sourceDirection, SourceOrTarget::Enum targetDirection, CoordinateTuple* sourceCoordinates, Accuracy* sourceAccuracy, CoordinateTuple& targetCoordinates, Accuracy& targetAccuracy );


      GeodeticCoordinates* convertSourceToGeodetic( SourceOrTarget::Enum sourceDirection, CoordinateTuple* sourceCoordinates, char* sourceWarningMessage );


      void convertGeodeticToTarget( SourceOrTarget::Enum targetDirection, GeodeticCoordinates* _shiftedGeodetic, CoordinateTuple& targetCoordinates, char* targetWarningMessage );
      ...
      void convertCollection( const std::vector<MSP::CCS::CoordinateTuple*>& sourceCoordinatesCollection, const std::vector<MSP::CCS::Accuracy*>& sourceAccuracyCollection, std::vector<MSP::CCS::CoordinateTuple*>& targetCoordinatesCollection, std::vector<MSP::CCS::Accuracy*>& targetAccuracyCollection );
    };
  }
}
