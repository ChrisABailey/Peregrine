...
class pov_io_base
{
  public:
    ...
    inline bool eof (void) { return (fail ? true : feof (m_fp) != 0) ; }
    inline u_int32 tellg (void) { return (m_fp == NULL ? -1 : ftell (m_fp)) ; }
    inline pov_io_base& clearstate (void) { if (m_fp != NULL) fail = false ; return (*this) ; }
...
class pov_istream_class : public pov_io_base
{
  public:
    ...
    inline int32 Read_Byte (void) { return (fail ? EOF : fgetc (m_fp)) ; }
...
class pov_ostream_class : public pov_io_base
{
  public:
    ...
    inline pov_ostream_class& Write_Byte (byte data) { if (!fail) fail = fputc (data, m_fp) != data ; return (*this) ; }
    ...
    inline pov_ostream_class& operator<<(char *s) { write (s, (u_int32) strlen ((char *) s)) ; return *this ; }
