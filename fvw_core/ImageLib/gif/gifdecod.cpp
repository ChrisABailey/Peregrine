...
*
* $File: //depot/povray/3.5/source/gifdecod.cpp $
* $Revision: #10 $
* $Change: 1817 $
 ...
 */
  short CReadGif::init_exp (int i_size)
{
	short size;
...
void CReadGif::cleanup_gif_decoder ()
{
	if (dstack)
		free (dstack);
	if (suffix)
...
short CReadGif::decoder (int i_linewidth)
{
	short linewidth;
