...
// scales
#define ONE_TO_250K 250000
#define ONE_TO_100K 100000
#define ONE_TO_63360 63360
#define ONE_TO_30K 30000
#define ONE_TO_25K 25000
#define ONE_TO_24K 24000
#define ONE_TO_20K 20000
#define ONE_TO_80M 80000000
#define ONE_TO_40M 40000000
#define ONE_TO_20M 20000000
#define ONE_TO_10M 10000000
#define ONE_TO_5M 5000000
#define ONE_TO_2M 2000000
#define ONE_TO_1M 1000000
#define ONE_TO_500K 500000
#define ONE_TO_50K 50000
#define ONE_TO_10K 10000
#define ONE_TO_5K 5000
#define ONE_TO_2K 2000
#define ONE_TO_1K 1000
#define ONE_HUNDRED_METER 671403
#define FIFTY_METER 335701
#define TWENTY_METER 134280
#define TEN_METER 67140
#define FIVE_METER 33570
#define TWO_METER 13428
#define ONE_METER 6714
#define T_600_CM 4028
#define T_500_CM 3357
#define T_300_CM 2014
#define T_150_CM 1007
#define T_75_CM 503
#define T_50_CM 335
#define T_25_CM 167
...
// series
#define BLACK_AND_WHITE_SERIES L"B&W"
#define COLOR_SERIES L"Color"
#define COLOR_INFRARED_SERIES L"CIR"
...
extern int geotiff_num_linear_units_names;
extern value_name geotiff_linear_units_names[17];

extern int geotiff_num_angular_units_names;
extern value_name geotiff_angular_units_names[10];

extern int geotiff_num_geographic_type_names;
extern value_name geotiff_geographic_type_names[170];

extern int geotiff_num_datum_names;
extern value_name geotiff_datum_names[157];

extern int geotiff_num_prime_meridian_names;
extern value_name geotiff_prime_meridian_names[13];

extern int geotiff_num_ellipse_names;
extern value_name geotiff_ellipse_names[37];

extern int geotiff_num_pcs_names;
extern value_name geotiff_pcs_names[980];

extern int geotiff_num_proj_names;
extern value_name geotiff_proj_names[300];

extern int geotiff_num_ct_names;
extern value_name geotiff_ct_names[38];

extern int geotiff_num_vert_cs_names;
extern value_name geotiff_vert_cs_names[40];
...
typedef struct
{
   int     from_ellips; /* CC1, DT. isph in FORTRAN; nnfr in NT MADTRAN */
   double  from_a;      /* CC1, DT */
   double  from_f;      /* CC1, DT */
   double  from_e_sq;   /* DT */
   int     to_ellips;   /* CC2. nnto in NT MADTRAN */
   double  to_a;        /* CC2 */
   double  to_f;        /* CC2 */
   double  da;          /* DT */
   double  df;          /* DT */
...
the transformation and conversion algorithms.  "from_" values
and "to_" values belong to the from ellipsoid and to ellipsoid
respectively. da and df are the deltas between the two ellipsoids'
semi-major axes and flattening values (to-ellipsoid minus from-
ellipsoid). Comments following each parameter indicate which algorithm
uses it: DT = datum transformation, CC1 = coordinate conversion on initial
point, and CC2 = coordinate conversion on transformed point.
*/
...
#define MAX_DATUM_CODE_SIZE       5
#define MAX_DATUM_NAME_SIZE      34
#define MAX_DATUM_AREA_SIZE      56
#define MAX_DATUM_CATEGORY_SIZE  40

typedef struct
{
   char  code[MAX_DATUM_CODE_SIZE+1];
   char  name[MAX_DATUM_NAME_SIZE+1];
   int   ellips_num;
   int   dx;
   int   dy;
   int   dz;
   char  area[MAX_DATUM_AREA_SIZE+1];
   int   ex;
   int   ey;
   int   ez;
   char  category[MAX_DATUM_CATEGORY_SIZE+1];
} DATUM_TYPE;
...
#define NUM_ELLIPSES             28
#define MAX_ELLIPSES_NAME_SIZE     25

typedef struct
{
   char    name[MAX_ELLIPSES_NAME_SIZE+1];
   double  a;
   double  f;
   double  e_sq;
} ELLIPS_TYPE;
