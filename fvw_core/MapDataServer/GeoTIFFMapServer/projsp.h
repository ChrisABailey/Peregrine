...
public:
	...
	int set_datum(std::string datum_str);
...
protected:
	...
	int string_to_datum(std::string datum_str, long *datum);
	...
	int get_sp_data(long ind, long sphere, char *pname, int pname_len, long *id, long *units, double *table);
