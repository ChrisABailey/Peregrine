...
enum units_t { KM, NM, M, YARDS, FEET, SECONDS, MINUTES };
enum altTypeEnum { ORIGINAL_AGL, ORIGINAL_MSL, CURRENT_AGL, CURRENT_MSL};
#ifndef _WIN32
#define GEO_TOOL_DECLSPEC
#elif defined(COMPILING_GEO_TOOL)
#define GEO_TOOL_DECLSPEC __declspec(dllexport)
#else
#define GEO_TOOL_DECLSPEC __declspec(dllimport)
#endif
